...
headers = {}
resp = requests.get("https://api.smartsheet.com/2.0/reports/{0}?level=2&pageSize=100&include=objectValue".format(sheet_id), headers={"Authorization":"Bearer {0}".format(api_token)})
